...
function WomensWearPageContent() {
  ...
  const slides = [
    { id: "womens-1", desktopImage: "/lastimg.webp", mobileImage: "/lastimg.webp", alt: "Women's Fashion" },
    { id: "womens-2", desktopImage: "/2.jpg", mobileImage: "/m6.png", alt: "Women's Wear" },
    { id: "womens-3", desktopImage: "/cloth2.webp", mobileImage: "/cloth2.webp", alt: "Women's Style" },
  ]
  ...
  const fetchProducts = useCallback(async (isLoadMore = false) => {
    try {
      ...
      queryParams.append('subcategory', 'womens-wear')
