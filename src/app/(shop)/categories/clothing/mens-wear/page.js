...
function MensWearPageContent() {
  ...
  const slides = [
    { id: "mens-1", desktopImage: "/2.jpg", mobileImage: "/m6.png", alt: "Men's Fashion" },
    { id: "mens-2", desktopImage: "/cloth2.webp", mobileImage: "/cloth2.webp", alt: "Men's Wear" },
    { id: "mens-3", desktopImage: "/lastimg.webp", mobileImage: "/lastimg.webp", alt: "Men's Style" },
  ]
  ...
  const fetchProducts = useCallback(async (isLoadMore = false) => {
    try {
      ...
      queryParams.append('subcategory', 'mens-wear')
            ...
            <div className="flex-1">
              ...
              {loading ? (
                ...
                <div className="text-center py-20 bg-white rounded-xl border border-dashed border-gray-300">
                  ...
                  <button onClick={() => setFilters({ category: "", priceRange: { min: 0, max: 10000 }, rating: null, inStock: false, search: "" })} className="mt-4 px-6 py-2 bg-[#5A0117] text-white rounded-lg hover:bg-[#4a0113] transition-colors">Clear Filters</button>
                </div>
              )}
