...
function JewelleryPageContent() {
  ...
  const slides = [
    ...
    {
      id: "jewellery-2",
      desktopImage: "/jewelery.webp",
      mobileImage: "/jewelery.webp",
  ...
  const fetchProducts = async (isLoadMore = false) => {
    try {
      ...
      queryParams.append('category', 'jewellery')
...
export default function JewelleryPage() {
  return (
    <Suspense fallback={<JewelleryPageLoading />}>
