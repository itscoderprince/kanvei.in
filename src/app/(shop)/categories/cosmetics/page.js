...
function CosmeticsPageContent() {
  ...
  const slides = [
    {
      id: "cosmetics-1",
      desktopImage: "/cosmetic.webp",
      mobileImage: "/cosmetic.webp",
  ...
  const fetchProducts = useCallback(async (isLoadMore = false) => {
    try {
      ...
      queryParams.append('category', 'cosmetics')
...
export default function CosmeticsPage() {
  return (
    <Suspense fallback={<CosmeticsPageLoading />}>
